...
//       gsap.utils.toArray('.elevated-card').forEach((card: any) => {
...
//             exceptional digital experiences. Select the perfect package tailored to your creative vision.
//           </p>
...
//           <div 
//             ref={addCardToRefs}
//             className="elevated-card bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8 transition-all duration-500 hover:border-purple-500/30"
//           >
//             <div className="flex justify-between items-start mb-8">
//               <div>
//                 <span className="text-sm font-medium text-purple-400 mb-2">ESSENTIALS</span>
//                 <h3 className="text-2xl font-semibold text-white">Design Foundations</h3>
//                 <p className="text-gray-400 mt-2 font-light">
//                   Core components for visionary creators
//                 </p>
//               </div>
...
//               <div className="text-gray-400 font-light">One-time payment</div>
//               <div className="text-sm text-gray-500 mt-2 font-light">
//                 Trusted by 500+ elite designers
//               </div>
//             </div>
            
//             <div className="border-t border-gray-700/50 pt-6 mb-8">
//               <h4 className="font-medium text-gray-300 mb-4">INCLUDED FEATURES:</h4>
...
//             <button className="luxury-btn w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-lg">
//               Begin Your Creative Journey
//             </button>
//             <p className="text-center text-gray-500 text-xs mt-3 font-light">
//               For individual creators and personal projects
//             </p>
//           </div>
...
//           <div 
//             ref={addCardToRefs}
//             className="elevated-card bg-gray-800/80 backdrop-blur-sm rounded-xl border-2 border-purple-500/50 p-8 relative overflow-hidden transition-all duration-500 hover:border-purple-500/80"
//           >
...
//             <div className="flex justify-between items-start mb-8">
//               <div>
//                 <span className="text-sm font-medium text-indigo-400 mb-2">PROFESSIONAL</span>
//                 <h3 className="text-2xl font-semibold text-white">Complete Toolkit</h3>
//                 <p className="text-gray-400 mt-2 font-light">
//                   Everything for professional designers
//                 </p>
//               </div>
...
//               <div className="text-gray-400 font-light">One-time payment</div>
//               <div className="text-sm text-gray-500 mt-2 font-light">
//                 Preferred by 1,200+ design professionals
//               </div>
//             </div>
...
//             <button className="luxury-btn w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-lg">
//               Elevate Your Workflow
//             </button>
//             <p className="text-center text-gray-500 text-xs mt-3 font-light">
//               For professional designers and agencies
//             </p>
//           </div>
...
//           <div 
//             ref={addCardToRefs}
//             className="elevated-card bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8 transition-all duration-500 hover:border-pink-500/30"
//           >
//             <div className="flex justify-between items-start mb-8">
//               <div>
//                 <span className="text-sm font-medium text-pink-400 mb-2">ENTERPRISE</span>
//                 <h3 className="text-2xl font-semibold text-white">Unlimited Access</h3>
//                 <p className="text-gray-400 mt-2 font-light">
//                   For commercial products and teams
//                 </p>
//               </div>
...
//             <button className="luxury-btn w-full bg-gradient-to-r from-pink-600 to-rose-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 hover:shadow-lg">
//               Unlock Commercial Potential
//             </button>
//             <p className="text-center text-gray-500 text-xs mt-3 font-light">
//               For product teams and commercial redistribution
//             </p>
//           </div>
//         </div>
...
//               Join an exclusive community of forward-thinking designers and developers who rely on our 
//               components to create award-winning digital experiences.
//             </p>
...
//             Have specific requirements or need enterprise solutions? Our design specialists are 
//             standing by to craft the perfect package for your needs.
//           </p>
